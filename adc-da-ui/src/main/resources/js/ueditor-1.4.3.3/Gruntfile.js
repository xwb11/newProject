...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
                ...
                files: [
                    {
                        ...
                        src: [ '*.html', 'themes/iframe.css', 'themes/default/dialogbase.css', 'themes/default/images/**', 'dialog/**', 'lang/**', 'third-party/**' ],
                        dest: disDir
        ...
        replace: {
            ...
            fileEncode: {
                src: [ disDir + '**/*.html', disDir + 'dialog/**/*.js', disDir + '**/*.css', disDir + '**/*.php', disDir + '**/*.jsp', disDir + '**/*.ashx', disDir + '**/*.asp' ],
                overwrite: true,
                replacements: [
                    {
                        from: /utf-8/gi,
